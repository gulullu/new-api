...
*/
export function RelayBasesOidcIcon({ displayName }: { displayName: string }) {
  if (!/^google(?:\s|$)/i.test(displayName.trim())) return null
  ...
  return (
    <svg viewBox='0 0 24 24' aria-hidden='true' className='h-4 w-4'>
      ...
      <path
        fill='#FBBC05'
        d='M6.39 13.93A6 6 0 0 1 6.08 12c0-.67.12-1.32.31-1.93V7.45H3.04A10 10 0 0 0 2 12c0 1.61.38 3.13 1.04 4.55l3.35-2.62Z'
      />
      <path
        fill='#EA4335'
