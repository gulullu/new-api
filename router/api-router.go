...
func SetApiRouter(router *gin.Engine) {
	...
	{
		registerPartnerRoutes(apiRouter)
		...
		apiRouter.GET("/site-access-policy", middleware.DisableCache(), controller.GetSiteAccessPolicy)
		apiRouter.PUT("/site-access-policy", middleware.RootAuth(), middleware.DisableCache(), controller.UpdateSiteAccessPolicy)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/referral-rewards", middleware.DisableCache(), controller.GetReferralRewards)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/ip-summary", controller.GetSuspiciousLoginIPs)
				adminRoute.PUT("/ip-blacklist", controller.UpdateIPBlacklist)
				...
				adminRoute.POST("/manage/batch-disable", controller.BatchDisableUsers)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/waffo-pancake/cny-product", controller.CreateWaffoPancakeCNYProduct)
