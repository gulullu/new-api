...
var defaultCacheRatio = map[string]float64{
	// Gemini 3.7 Flash high/low cache-read/input ratio: Ɍ0.075 / Ɍ0.75.
	"gemini-3.7-flash":      0.1,
	"gemini-3.7-flash-high": 0.1,
	"gemini-3.7-flash-low":  0.1,
	...
	"gpt-6-astra":                         0.1, // $1 cached input / $10 input
	"glm-5.2":                             0.25,
	"glm-5.3":                             0.25,
	"grok-4.5":                            0.25,
	"grok-4.6":                            0.25,
...
var defaultCreateCacheRatio = map[string]float64{
	...
	"gpt-5.6-terra":                       1.25,
	"gpt-5.6-luna":                        1.25,
	"gpt-6-astra":                         1.25, // $12.5 cache writes / $10 input
