...
func InitOptionMap() {
	...
	common.OptionMap[common.BlockedIPsOptionKey] = "[]"
	common.OptionMap[common.MainlandSiteBlockOptionKey] = "true"
	...
	common.OptionMap["WaffoPancakeCNYProductID"] = setting.WaffoPancakeCNYProductID
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "WaffoPancakeCNYProductID":
		setting.WaffoPancakeCNYProductID = value
